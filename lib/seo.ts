...
/**
 * صور Open Graph لصفحة — أربعة مرشّحين بترتيب من الأخصّ إلى الأعمّ:
 * صورة **هذه الصفحة** ← صورة الموقع من الإعدادات ← شعار العلامة ← الملف المرفق.
 *
 * والترتيب مقصود لا اعتباطي: صفحةٌ لها صورتها أولى بها من صورة عامة، وصورةٌ
 * صمّمها المالك للمشاركة أولى من شعاره، وشعارُه أفضل من لا شيء.
 *
...
function ogImages(settings: SiteSettings, pageImage: string | null): ShareImage[] {
  ...
  for (const candidate of [pageImage, settings.seo.ogImageUrl, settings.brand.logoUrl]) {
