...
export const FIELD_LABELS: Record<string, FieldLabel> = {
  ...
  note: { label: "ملاحظة" },
  /**
   * 🆕 **`listLabel` — تسمية قائمة الشعارات لقارئ الشاشة (‏`0101`، 2026-08-17).**
   *
   * أُضيفت لأنها كانت **محفورةً في العارضة بلا مسار `content`**: قيمةٌ تُصيَّر
   * `aria-label` على الموقع الحيّ ولا يبلغها المالك من اللوحة ولا من القاعدة.
   * ونصُّ المساعدة يقول **سلوك الفراغ صراحةً** — وهذا ما يفرق بينها وبين
   * `disclaimer` المحذوف: عِلّةُ ذاك كانت أنه يعيد نفسه **صامتاً**، لا أنه يعيد
   * نفسه. وحقلٌ غير مرئيٍّ يُفرَّغ فيصير `<ul>` بلا اسم انحدارٌ لا يراه من سبّبه.
   */
  listLabel: {
    label: "تسمية القائمة لقارئ الشاشة",
    help:
      "اسمٌ لا يُرى على الشاشة: يسمعه من يتنقّل بقارئ شاشة فيعرف ما هذه القائمة من الشعارات قبل أن يمرّ عليها. " +
      "ويُترجَم كأي نصّ. ⚠ والفارغ يعيد التسمية الافتراضية ولا يحذفها — قائمةٌ بلا اسم يمرّ عليها قارئ الشاشة بلا ما يعرّفها.",
  },
  /**
