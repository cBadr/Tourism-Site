...
/* ------------------------------------------------------------------ */
/* التواريخ — بتوقيت القاهرة دائماً                                      */
/* ------------------------------------------------------------------ */

/**
 * لماذا توقيت ثابت؟ صفحات المتابعة تُعرض من الخادم (UTC على المنصات السحابية)
 * بينما العميل في مصر — فبلا تثبيت المنطقة يظهر موعد الانطلاق بساعة مختلفة.
 * نستخرج المكوّنات عبر Intl بمنطقة `Africa/Cairo` (تراعي التوقيت الصيفي) ثم
 * نركّب النص يدوياً حتى تتطابق الصيغة مع بقية الواجهة في كل بيئة.
 */
...
/** مكوّنات التاريخ في منطقة القاهرة — ترجع null لأي تاريخ غير صالح */
