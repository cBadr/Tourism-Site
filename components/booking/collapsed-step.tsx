 ...
 *
 * وهو **مشترك بين سطحين** — خطوة إتمام الحجز وخطوة بيانات الرحلة — عمداً:
 * نسختان من «كيف تبدو خطوة منتهية» تنحرفان بأول تعديل، والعميل يرى في العمود
 * الواحد شكلين لشيء واحد.
 */
