 ...
 * - `denied`: المتصفح يمنع الصوت لهذا الموقع من إعداداته (نقرةٌ لن تكفي).
...
export const SOUND_FAILURE_TEXT: Record<SoundFailure, string> = {
  ...
  denied:
    "المتصفح يمنع الصوت لهذا الموقع من إعداداته. افتح إعدادات الموقع في المتصفح واسمح بالصوت، ثم انقر «فعّل الصوت».",
