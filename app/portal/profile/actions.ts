...
/**
 * ⚠ **المرساة جزءٌ من الوجهة** منذ صارت الصفحة أقساماً (2026-08-19): «حسابي»
 * تحمل ثلاثة أقسام، وقد يقع قسمُ الاتفاقية فوق قسم الحساب حين لا يكون الشريك قد
 * وقّع. فالعودةُ بلا مرساة كانت تُنزل الشريكَ في أعلى الصفحة بعد حفظه، فيبحث عن
 * نموذجه ولا يرى شريط النجاح ولا الحقل الذي أخطأ فيه.
 */
const url = (qs: string) => `/portal/profile?${qs}#account`;
