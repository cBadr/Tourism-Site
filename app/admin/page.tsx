              ...
              netDue === null
                ...
                : netDue > 0
                  ...
                  : netDue < 0
                    ...
                    : "تمت تصفية حساب المتعهدين"
            }
            value={netDue === null ? null : netDue < 0 ? -netDue : netDue}
            currency={currency}
            icon={Scale}
            help="صافي التسوية مع كل الشركاء مجتمعين: مستحقاتهم ناقص ما حصّلوه نقداً من عملائنا ناقص ما دفعناه لهم. موجب = ندفع، وسالب = نستردّ — والاتجاه مكتوب في العنوان فلا تقرأ الرقم مجرَّداً."
            /*
              الاتجاهان ليسا درجتَي خطورة لشيء واحد بل حالتان مختلفتان:
              «علينا» دفعة قادمة تخرج من الخزينة (كهرماني)، و«لنا» مال في يد
              الشركاء يُحصَّل (أزرق). التسوية الصفرية لا تُلوَّن.
            */
            variant={
