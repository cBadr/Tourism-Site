 ...
 *
 * قبل هذه الهجرة كانت معادلة المقاصة ثلاثية (`earned − collected − paid`) ولا
...
export function CollectionForm({
   ...
   * تعني «عليه لنا»؛ وما عداها (له علينا · مصفّى · غير مقروء) تجاوزٌ صريح.
   */
          ...
          {debtor ? (
            <>
              <p>
                ...
                العملاء أكثر من مستحقه. الاتجاه اختير من صافي مقاصته لا باليد —{" "}
