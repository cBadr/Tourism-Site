...
export const SOURCE_HINTS: Record<string, string> = {
  ...
  partner_payout: "دفعة نقدية سُدّدت لمتعهد ضمن التسويات — خرجت من خزينتنا فعلاً.",
  partner_collection:
...
// ---------------------------------------------------------------------------
// الالتواء المحاسبي: صياغة التسوية بإشارتيها
// ---------------------------------------------------------------------------
...
export type SettlementWording = {
  ...
  text: string;
  /** جملة الحكم الكاملة — حيث تُعرض التسوية بطاقةً لا وسماً */
  verdict: string;
  /**
...
const LIMIT_STATES = {
  ...
  unknown: {
    ...
    consequence:
      "بلغ هذا المتعهد سقف الدين. أما هل توقّف الإسناد إليه فعلاً فلا تقوله هذه الشاشة: تعذّرت قراءة إعدادات سقف الديون، فافتح بطاقة سقف الديون في شاشة التسويات لترى حالة مفتاح «حجب العروض».",
  },
} as const;

/**
 * صياغة صافي التسوية بالعربية الصحيحة لكل إشارة.
 *
 ...
 * التسويات، كشف الحساب، ملف المتعهد، ونموذج الدفع). أي صياغة جديدة — ومنها وسم
...
export function settlementWording(
  ...
  if (netDue === null) {
    return {
      tone: "settled",
      text: "—",
      verdict: "الرقم غير متاح — تعذّرت قراءة التسوية.",
      magnitude: null,
      hint: "الرقم غير متاح — تعذّرت قراءة التسوية.",
      ...limit,
    };
  }
  ...
  return {
    tone: "settled",
    text: "تسوية صفرية",
    verdict: "تمت تصفية الحساب — لا مستحقات في الاتجاهين",
    magnitude,
...
/** نبرة **لوح** التسوية الكبير (ملف المتعهد) — نفس النبرات بخلفية أهدأ من الوسم */
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          <span className="flex items-center gap-1.5 text-sm font-medium">
            ...
            <HelpTip>
              ...
              عدا ما يُعلَّم صراحةً بأنه «لحظي» (رصيد الخزائن وتسويات المتعهدين)، فهو صورة
              الآن لا مجموع فترة.
            </HelpTip>
          </span>
