  ...
  return (
    ...
    >
      <StatsPanel
        ...
        icon={Banknote}
        help="الوارد والمنصرف الفعليان من حسابات الخزينة، مجمَّعان يوماً بيوم داخل قاعدة البيانات. نقد داخل وخارج فعلاً لا استحقاقات: مستحق متعهد لم يُدفع بعد لا يظهر هنا، ويظهر في «تسويات المتعهدين» بشاشة المالية."
