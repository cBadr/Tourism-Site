...
![Migrations](https://img.shields.io/badge/migrations-74-informational)
...
**الترحيلات الـ ٧٤** في `supabase/migrations/` من `0001_core.sql` إلى `0074_guarantees_compact_layout.sql` — كلها مطبَّقة على القاعدة الحية ومتتبَّعة في `schema_migrations`. **ومجموعات الاختبار الثلاث والعشرون** في `supabase/tests/`. خريطة الترحيلات بالمرحلة في [`handover/ARCHITECTURE.md`](handover/ARCHITECTURE.md) القسم ٧.
