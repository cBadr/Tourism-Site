...
![Migrations](https://img.shields.io/badge/migrations-72-informational)
...
**الترحيلات الـ ٧٢** في `supabase/migrations/` من `0001_core.sql` إلى `0072_logo_strip_disclaimer.sql` — كلها مطبَّقة على القاعدة الحية ومتتبَّعة في `schema_migrations`. **ومجموعات الاختبار الثلاث والعشرون** في `supabase/tests/`. خريطة الترحيلات بالمرحلة في [`handover/ARCHITECTURE.md`](handover/ARCHITECTURE.md) القسم ٧.
